		...
		<div class="row">
			<div class="col-md-9">
				<div class="container" style="background-color: white; margin-bottom: 30px; padding-top: 30px; padding-right: 35px; padding-left: 35px; padding-bottom: 30px;">
					<?php $detail=$data->select_detail_kegiatan($_GET['id']); ?>
					<?php foreach ($detail as $key => $value): ?>
						<h4 style="color: #6E6E6E;"><b><?php echo $value['nama']?></b></h4>
						<p style="font-size: 13px; margin-bottom: -6px; color: #A4A4A4;">
							...
							<p style="font-size: 18px; text-align: justify; margin-top: -15px;"><?php echo $value['deskripsi']?></p>
						<?php endforeach?>
					</div>
				</div>
				<div class="col-md-3">

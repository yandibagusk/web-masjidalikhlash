		...
		<div class="row">
			<div class="col-md-9">
				<div class="container" style="background-color: white; margin-bottom: 30px; padding-top: 30px; padding-right: 35px; padding-left: 35px; padding-bottom: 30px;">
					<h4 style="color: #6E6E6E;"><b>Kegiatan</b></h4>
					<hr>
					<?php $kegiatan=$data->select_kegiatan_all()?>
					<?php foreach ($kegiatan as $key => $value): ?>
						<div class="row">
							...
							<div class="col-md-10">
								<b><p style="font-size: 18px; margin-bottom: -1px; color: #006400;"><?php echo $value['nama']; ?></p></b>
								<p style="text-align: justify; margin-top: -15px;"><?php echo substr($value['deskripsi'], 0, 210); ?><b><a href="index.php?page=detailkegiatan&id=<?php echo $value['id_kegiatan'];?>">&nbsp;&nbsp;[Read More]</a></b></p>

<script type="text/javascript">
	$(document).ready(function(){
		$(".editlink").click(function(){
			...
			var status = $(this).closest('tr').find('td.edt_status').html();
...
<div style="padding: 25px" class="animated fadeIn" id="tampil">
	<div class="row">
		...
		<div class="col-md-6">
			<button class="btn btn-success btn-sm" style="float: right" data-toggle="modal" data-target="#modalTambah"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah User</button>
		</div>
	</div>
	<hr>
	<form method="POST">
			...
			<tbody style="font-size: 14px;">
				...
				<?php foreach ($user as $key => $value): ?>
					<tr>
						...
						<td class="edt_status"><?php echo $value['status']; ?></td>
						<td>
							<?php if($value['hak_akses']=='Superadmin') {?>
			...
			<div class="modal-body">
				<form method="POST">
					...
					if (isset($_POST['simpan'])) {
						$data->add_user($_POST['id_user'],$_POST['username'],$_POST['password'],$_POST['hak_akses'],$_POST['status']);
					}
					?>
				</form>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST">
					...
					<?php
					if(isset($_POST['ubah'])){
						$data->update_user($_POST['id_user'],$_POST['username'],$_POST['password'],$_POST['hak_akses'],$_POST['status']);
					}
					?>
				</form>
			</div>
